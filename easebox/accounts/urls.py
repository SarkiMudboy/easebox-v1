...
from .views import RegisterView, PhoneNumberVerificationView, EmailVerificationView, EmailConfirmationView
...
confirm_email = EmailConfirmationView.as_view({"post": "confirm_email_token"})
